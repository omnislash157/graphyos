...
<!-- graphy:arm PRODUCE generated — do not edit inside this region; `graphy arms` regenerates it, `graphy arms --verify` names drift
     store=cd5fd90fb0197d6e cut=sha256:a6e7f6dc67aab9bb6fd7793a207caee4a59936ab2d05b2d99191628da7cda284 content=sha256:4b12a6280ecb04f471b7a703b43957841e2e95380e3efe0d160a6fb3020cb453 -->
...
**`graphy.native_json_graph_ir`** — classes: `OverrideIR` · `OverrideRecord` (1) · `ResolvedShard`; functions: `_canonical_payload` · `_classify_path` · `_detect_alias_cycle` · `_detect_duplicate_json_keys` · `_escape_json_pointer_segment` · `_json_pointer` · `_scalar_leaves` · `_sidecar_edges` · `load_graph_ir` · `load_override_ir` · `validate_shard`
**`graphy.parity`** — classes: `Golden` (2) · `Harness` (5) · `ParityError` · `_NotJson` (1); functions: `_as_json` · `_eq` · `_witness` · `json_equal` · `load_golden`
**`graphy.provision`** — classes: `Provisioned`; functions: `_run` · `provision`
