...
<!-- graphy:arm PRODUCE generated — do not edit inside this region; `graphy arms` regenerates it, `graphy arms --verify` names drift
     store=c8b7e4b36bf80c18 cut=sha256:a6e7f6dc67aab9bb6fd7793a207caee4a59936ab2d05b2d99191628da7cda284 content=sha256:fc02420eb0fad9ba354096f830256ddcfd2dd04ab6236588127aae98ae17e43b -->
...
**`graphy.adapters.python_ast`** — classes: `_NodeRecords` (1); functions: `_defs_in` · `_dotted_for` · `_emit_import_edges` · `_emit_raw_records_for_file` · `_emit_records_for_file` · `_expr_repr` · `_is_excluded` · `_local_package_names` · `_node_id` · `_resolve_module_dst` · `_scan` · `_scheme_of` · `_walk_stmt` · `build_ir` · `is_package_dir` · `mint_records` · `walk_files`
