...
<!-- graphy:arm PRODUCE generated — do not edit inside this region; `graphy arms` regenerates it, `graphy arms --verify` names drift
     store=a27be47e6a42c341 cut=sha256:0f1d43aa1cb87a767f760bdce58094258cb244f46054c04b6f20ee098f6e3cd8 content=sha256:cfafd5a1e93f32517eb5e263e1b81890fb8e6b0677e93a624bb2d02dadacafcd -->
...
**`graphy.adapters.history`** — classes: `HistoryError`; functions: `_alias_rx` · `_code_nodes` · `_digest` · `_git` · `_inputs` · `_iso` · `_numbers` · `bind` · `build_ir` · `code_index` · `inputs_of` · `literals_of` · `mint` · `module_id_of` · `read_aliases` · `read_commits` · `read_exchanges` · `read_receipts` · `read_sections` · `read_sessions` · `remint` · `symbol_index` · `verify`
**`graphy.adapters.outline`** — classes: `_NodeRecords` (1); functions: `_slugify` · `build_ir` · `parse_outline`
**`graphy.adapters.python_ast`** — classes: `_Everything` (1) · `_NodeRecords` (1) · `_Scopes` (4); functions: `_bindable_annotations` · `_bound_here` · `_class_info` · `_defs_in` · `_demangle` · `_dotted_for` · `_emit_import_edges` · `_emit_raw_records_for_file` · `_emit_records_for_file` · `_escapes` · `_expr_repr` · `_is_bound_shape` · `_is_comprehension` · `_is_excluded` · `_local_package_names` · `_module_bindings` · `_name_chain` · `_node_id` · `_param_names` · `_reference_edges` · `_resolve_module_dst` · `_scan` · `_scheme_of` · `_walk_stmt` · `build_ir` · `is_package_dir` · `mint_records` · `read_source` · `scope_bindings` · `walk_files` · `walk_files_naming_skips`
**`graphy.adapters.typescript_ast`** — classes: `ProducerUnavailable` · `_Wrap` (1); functions: `_alias_targets` · `_assigned_functions` · `_block_names` · `_bound_names` · `_calls_in` · `_decorators` · `_dotted_for` · `_expr_repr` · `_func_of_lexical` · `_heritage` · `_hoisted` · `_jsonc` · `_kind` · `_module_at` · `_module_bound` · `_module_for_specifier` · `_node_id` · `_parsers` · `_pure_chain` · `_refs_in` · `_require_spec` · `_requires_in` · `_scope_of` · `_state_rune` · `_text` · `_unwrap_export` · `_walk_class` · `_walk_module` · `_write_label` · `_write_targets` · `_writes_in` · `alias_config` · `build_ir` · `component_script` · `excludes_for` · `is_package_dir` · `mint_records` · `slug_of_specifier` · `walk_files`
...
**`graphy.ir`** — classes: `Edge` (1) · `Evidence` (1) · `IRError` · `Node` (1) · `Provenance` (1) · `Vocabulary` (3); functions: `_is_int` · `_parse_endpoint` · `_parse_optional` · `_type_name` · `validate_graph`
...
Last walk: crown=`graphy://func/graphy.native_json_graph_ir.load_graph_ir` dependents in graphy=21 → arms/PRODUCE.walk.txt
