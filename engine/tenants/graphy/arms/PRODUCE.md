...
<!-- graphy:arm PRODUCE generated — do not edit inside this region; `graphy arms` regenerates it, `graphy arms --verify` names drift
     store=5577b094d4cc145b cut=sha256:0f1d43aa1cb87a767f760bdce58094258cb244f46054c04b6f20ee098f6e3cd8 content=sha256:657fef4eeeb8b7f8c5f1e744319c20bf546644d188c256e92e459a450ec5a5d9 -->
...
**`graphy.adapters.typescript_ast`** — classes: `ProducerUnavailable` · `_Wrap` (1); functions: `_assigned_functions` · `_block_names` · `_bound_names` · `_calls_in` · `_decorators` · `_dotted_for` · `_expr_repr` · `_func_of_lexical` · `_heritage` · `_hoisted` · `_kind` · `_module_for_specifier` · `_node_id` · `_parsers` · `_require_spec` · `_requires_in` · `_scope_of` · `_state_rune` · `_text` · `_unwrap_export` · `_walk_class` · `_walk_module` · `_write_label` · `_write_targets` · `_writes_in` · `build_ir` · `component_script` · `excludes_for` · `is_package_dir` · `mint_records` · `slug_of_specifier` · `walk_files`
...
Last walk: crown=`graphy://func/graphy.native_json_graph_ir.load_graph_ir` dependents in graphy=17 → arms/PRODUCE.walk.txt
