...
<!-- graphy:arm PRODUCE generated — do not edit inside this region; `graphy arms` regenerates it, `graphy arms --verify` names drift
     store=17340ab7f2dc9bda cut=sha256:0f1d43aa1cb87a767f760bdce58094258cb244f46054c04b6f20ee098f6e3cd8 content=sha256:8e1f55850f9a6c2a2b54ad79df1a415729eba21f2feccf9f05bd0ce5fff1e92c -->
...
**`graphy.adapters.history`** — classes: `HistoryError`; functions: `_alias_rx` · `_code_nodes` · `_digest` · `_git` · `_inputs` · `_iso` · `_numbers` · `bind` · `build_ir` · `code_index` · `literals_of` · `mint` · `module_id_of` · `read_aliases` · `read_commits` · `read_exchanges` · `read_receipts` · `read_sections` · `read_sessions` · `symbol_index` · `verify`
**`graphy.adapters.outline`** — classes: `_NodeRecords` (1); functions: `_slugify` · `build_ir` · `parse_outline`
**`graphy.adapters.python_ast`** — classes: `_NodeRecords` (1); functions: `_bindable_annotations` · `_class_info` · `_defs_in` · `_dotted_for` · `_emit_import_edges` · `_emit_raw_records_for_file` · `_emit_records_for_file` · `_escapes` · `_expr_repr` · `_is_bound_shape` · `_is_excluded` · `_local_package_names` · `_module_bindings` · `_name_chain` · `_node_id` · `_param_names` · `_rebound_names` · `_reference_edges` · `_resolve_module_dst` · `_scan` · `_scheme_of` · `_shadow_in` · `_walk_stmt` · `build_ir` · `is_package_dir` · `mint_records` · `read_source` · `walk_files` · `walk_files_naming_skips`
**`graphy.adapters.typescript_ast`** — classes: `ProducerUnavailable` · `_Wrap` (1); functions: `_assigned_functions` · `_block_names` · `_bound_names` · `_calls_in` · `_decorators` · `_dotted_for` · `_expr_repr` · `_func_of_lexical` · `_heritage` · `_hoisted` · `_kind` · `_module_bound` · `_module_for_specifier` · `_node_id` · `_parsers` · `_pure_chain` · `_refs_in` · `_require_spec` · `_requires_in` · `_scope_of` · `_state_rune` · `_text` · `_unwrap_export` · `_walk_class` · `_walk_module` · `_write_label` · `_write_targets` · `_writes_in` · `build_ir` · `component_script` · `excludes_for` · `is_package_dir` · `mint_records` · `slug_of_specifier` · `walk_files`
