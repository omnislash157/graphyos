...
<!-- graphy:arm SEAM generated — do not edit inside this region; `graphy arms` regenerates it, `graphy arms --verify` names drift
     store=a091d432f60b7406 cut=sha256:a6e7f6dc67aab9bb6fd7793a207caee4a59936ab2d05b2d99191628da7cda284 content=sha256:b25ac8b8efaff764d7760c67ecd872e0d5295aa3579a065de5d8ebf5625ae4fc -->
...
**`graphy.cartograph`** — functions: `_behind_commits` · `_build` · `_cli_tenant` · `_shell_quote_out` · `cartograph` · `code_graph_publish_inplace` · `ensure_fresh` · `main` · `repo_head_sha` · `resolve_graph` · `write_graph`
**`graphy.container`** — classes: `ContainerError`; functions: `_attrs` · `_duckdb` · `_edge_rows` · `_node_rows` · `_write_parquet` · `emit` · `emit_all` · `estate` · `have_duckdb` · `node_forms` · `shard_digest` · `summarize` · `verify`
**`graphy.converge`** — classes: `Ring` (7); functions: `_dotted_of_id` · `_label_edges` · `_qualify` · `_resolve_one` · `_standard_of` · `_through_package` · `converge` · `load_ring` · `resolve`
...
**`graphy.federated_store`** — classes: `Neighbour` · `SQLiteStore` (10) · `ShardStore` (11) · `StaleCursorError` (1) · `StoreError` · `WalkCursor` (3) · `_StoreAdj` (4); functions: `_advance` · `_as_cursor` · `_compute_input_digest` · `_finish` · `_frames` · `_generation_digest` · `_registry_input_digest` · `_repair_hint` · `_require_same_generation` · `_scheme_index_input_digest` · `_sha16` · `_shard_input_digest` · `compile_store` · `frames` · `main` · `open_for` · `path_to` · `resume` · `spread` · `store_path_for`
