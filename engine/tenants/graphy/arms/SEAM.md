...
<!-- graphy:arm SEAM generated — do not edit inside this region; `graphy arms` regenerates it, `graphy arms --verify` names drift
     store=0a4ab5e8f4bfac97 cut=sha256:a6e7f6dc67aab9bb6fd7793a207caee4a59936ab2d05b2d99191628da7cda284 content=sha256:2427925492b5a82f1012e03a361c2cb092f3d4cb3f9766aba9d6cc4d8bd82f81 -->
...
**`graphy.cartograph`** — functions: `_behind_commits` · `_build` · `_cli_tenant` · `_shell_quote_out` · `cartograph` · `code_graph_publish_inplace` · `cursor_drift` · `ensure_fresh` · `main` · `repo_cursor` · `repo_head_sha` · `resolve_graph` · `tenant_exclude` · `working_tree_dirt` · `write_graph`
