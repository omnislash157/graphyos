...
<!-- graphy:arm DOORS generated — do not edit inside this region; `graphy arms` regenerates it, `graphy arms --verify` names drift
     store=5577b094d4cc145b cut=sha256:0f1d43aa1cb87a767f760bdce58094258cb244f46054c04b6f20ee098f6e3cd8 content=sha256:43a79eec4dcee237ba30b39ec38043d6ee88c655001c25c510c7e9c08b231b59 -->
...
**`graphy.mcp`** — classes: `Doors` (14) · `ToolError`; functions: `_error` · `_result` · `handle` · `open_tools` · `serve`
