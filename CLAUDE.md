...
cli.py                  graphy eat | init | smash | history | push | pull | index | converge | build | container | estate | walk | bridge | arms | farm | draw | showcase | harness | descend | blast | explain | pillars | refresh | mcp | traversals | shell | check | fanout — exit 0 healthy · 1 audit verdict · 2 never ran
```
